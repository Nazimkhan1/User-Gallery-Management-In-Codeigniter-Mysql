    ...
    <section class="content">
      <div class="row">
        ...
        <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Article/saveArticle" enctype="multipart/form-data">
              <div class="box-body">
        ...
        <?php echo form_error('article_title','<span class="help-block" style="color:red;"">','</span>'); ?>
        </div>
        </div>
				...
				<?php echo form_error('article_image','<span class="help-block" style="color:red;"">','</span>'); ?>
				</div>
				</div>
				</div>
